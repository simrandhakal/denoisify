    ...
    return (
      <div className="px-[8rem] py-[7rem] flex flex-col gap-[5rem]" id="feature">
        ...
        <div className="grid grid-cols-2 gap-6">
          {[
            { title: "Noise Reduction Across Multiple Types", description: "Effectively removes noise types such as Gaussian, Speckle, Motion noise, and noise from low-light conditions, high ISO settings, and sensor errors." },
            ...
            { title: "AI-Powered Performance", description: "Uses advanced deep learning models like Pix2Pix GAN to intelligently distinguish noise from important image details, resulting in quality outputs." },
